...
image:
  feature: rabbit.jpg
---
I think it's reasonable to assume that any company that has a significant big business process, even complex at times, struggles at some point with the communication hell generated by the integration of so many different systems.

I would go further and say that this is the quintessential problem in the Cloud-era, where everything is distributed, and it must somehow use its communication capacities to spread the information across the globe.
